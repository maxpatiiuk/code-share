<?php
define('LINK','http://nauka.zzz.com.ua/');
define('_DOMAIN_','nauka.zzz.com.ua');
define('_LOCATION_',"http://nauka.zzz.com.ua/");
...
selCon('posts','n_posts');
selCon('users','n_users');
selCon('slider','n_slider');
selCon('email','max@patii.uk');
function head ($style=0, $cont=0, $title = 'Головна',$others=0){
	if($title!=NULL)
		$title.=' - ';
	$title.='Науковий блог - блок про новиники світу інформаційних технологій';
	...
	<header class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?=LINK?>"><img alt="Науковий блог" src="https://s8.hostingkartinok.com/uploads/images/2017/11/144cc3ba771754173943ab716bb93b23.png" style="height:75px;"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					?>
					<li>
						<a href="<?=LINK?>profile/?id=<?=_ID_?>" style="float:left"><img style="border-radius:100vh;height:60px;width:60px;" src="<?=$srr?>" alt="Профіль"></a>
