...
namespace cars
{
    ...
    class Race
    {
        ...
        public virtual void Start(object source, EventArgs e)
        {
            divide();
            for (int i = 0; i < 4; i++)
        ...
        public virtual void CarryOn(object source, EventArgs e)
        {
            int position = 0;
            bool was = true;
            while (was)
        ...
        public virtual void Finish(object source, EventArgs e)
        {
    ...
    /*public class Events
    {
        public void OnPrepared(object source, EventArgs e)
        {
            start();
        }
        public void OnPrepared(object source, EventArgs e)
