<?php
define('LINK','http://geolutsk.zzz.com.ua/');
define('_DOMAIN_','geolutsk.zzz.com.ua');
define('_LOCATION_',"http://geolutsk.zzz.com.ua/");
...
selCon('posts','g_posts');
selCon('mv','u');
selCon('users','g_users');
selCon('slider','g_slider');
...
selCon2('about',2);
$about=$row['value'];
selCon2('email','info@geolutsk.zzz.com.ua');
selCon2('tel1');
selCon2('tel2');
selCon2('address');
selCon2('fblink');
