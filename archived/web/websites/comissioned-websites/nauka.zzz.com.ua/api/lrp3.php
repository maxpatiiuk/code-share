...
function p($locations,$users='users',$domain="mambo.in.ua", $email=NULL, $name=NULL, $mail1=NULL, $mail2=NULL, $mail3=NULL){
	$us=$users;
	global $location,$row,$res,$id,$users,$u;
	$location=$locations;
	$users=$us;
	if($email==NULL)
		$email='max@patii.uk';
	if($name==NULL)
		$name='УАС';
	function err(){
		global $id,$u,$location;
		echo '<div class="alert alert-danger">Користувача не знайдено!<br><a href="'.$location.'">Повернутися на головну</a><br><a href="'.$location;
		if($u)
			echo 'profile/?id='.$id.'">Перейти в свій акаунт';
		else 
			echo 'login">Ввійти в акаунт</a><br><a href="'.$location.'register">Реєстрація';
		echo '</a></div>';
	}
					...
					<div class="tab-content">
						<div id="tab1" class="tab-pane fade<?=$tab1?>">
							...
							if (@getimagesize($lsrc.'jpg'))
								...
								$srr="https://s8.hostingkartinok.com/uploads/images/2017/11/54f80b408d5ab304d5abbc950e9a0f87.jpg";
							?><div class="row">
