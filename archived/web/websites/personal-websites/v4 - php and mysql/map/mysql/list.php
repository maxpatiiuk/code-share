		...
		<div class="cont">
			...
			<table>
				...
				while ($row=mysql_fetch_array($res))
				{
					...
					echo '<tr>
							<td><a href="'.LINK.'map/mysql/delete.php?id='.$id.'">'.$id.'</a></td>
							<td><a href="'.LINK.'map/mysql/delete.php?id='.$id.'">'.$name.'</a></td>
							<td><a href="'.LINK.'map/mysql/delete.php?id='.$id.'">'.$surname.'</a></td>
							<td><a href="'.LINK.'map/mysql/delete.php?id='.$id.'">'.$contacts.'</a></td>
							<td><a href="'.LINK.'map/mysql/delete.php?id='.$id.'">'.$sale.'</a></td>
							<td><a href="'.LINK.'map/mysql/delete.php?id='.$id.'">'.$products.'</a></td>
						</a></tr>';
				}
				if($ii<=0)
					echo '<tr>
