          ...
          <br><hr><br>
				...
				?><br><form action="<?=LINK?>adm/tests.php?r=edited&id=<?=$id?>" enctype="multipart/form-data" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="postClass" id="a4class" required>
								<option value="0" <?php if($c->g==0) echo 'selected';?>>Todos</option>
								<option value="5" <?php if($c->g==5) echo 'selected';?>>5</option>
								<option value="6" <?php if($c->g==6) echo 'selected';?>>6</option>
								<option value="7" <?php if($c->g==7) echo 'selected';?>>7</option>
								<option value="8" <?php if($c->g==8) echo 'selected';?>>8</option>
								<option value="9" <?php if($c->g==9) echo 'selected';?>>9</option>
								<option value="10" <?php if($c->g==10) echo 'selected';?>>10</option>
								<option value="11" <?php if($c->g==11) echo 'selected';?>>11</option>
							</select>
						</div>
					</div>
					<div class="form-group">
