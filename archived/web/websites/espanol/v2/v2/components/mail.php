...
class mail{
	...
	public static function content($subject,
		...
		$params['MAIN_PAGE_LINK'] = Site::$link;
	...
	public static function send($subject = 'New message',
	                            $content = '',
	                            $from = '',
	                            $to = '',
	                            $type = 'html'
		...
		return mail($to, $subject . ' - ' . Site::_NAME_, $content, "From: " . $from . "\r\n" . $type . "MIME-Version: 1.0\r\nReply-To: " . $from . "\r\nX-Mailer: PHP/" . phpversion());
	}
