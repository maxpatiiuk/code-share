			...
			<div class="container-fluid">
					...
					if($_GET['i']='edited' && isset($_POST['infEdit'])){
						...
						if($_FILES['logo']['size']>0){
							...
							if(isset($src2)){
								unlink('../images/p/logo.jpeg');
								unlink('../images/p/logo.jfjf');
								unlink('../images/p/logo.jpg');
								unlink('../images/p/logo.gif');
								unlink('../images/p/logo.png');
								unlink('../images/p/logo.tiff');
								unlink('../images/p/logo.bmp');
								unlink('../images/p/logo.tiff');
								unlink('../images/p/logo.svg');
					...
					controlInputs('Теги','tags','Вкажіть ключові слува, що описують вашу організацію');
