...
<html>
	...
	<body>
		...
		if($type==2)
			echo '<a style="color:#fff" class="btn btn-success" href="'.LINK.'adm/materials.php?a=editPost&id='.$pRow['id'].'">Редагувати тест</a><a style="color:#fff" class="btn btn-danger" href="'.LINK.'adm/material.php?tab=5&r=deleted&id='.$pRow['id'].'">Видалити тест</a><br>';
