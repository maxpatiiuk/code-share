<?php
define('LINK','http://modernvolyn.zzz.com.ua/');
define('_DOMAIN_','modernvolyn.zzz.com.ua');
define('_DEAFULT_AVA_','https://s8.hostingkartinok.com/uploads/images/2018/01/74c8325ebdff4081319b7ca7adf4e7e8.png');
define('_LOCATION_',"http://modernvolyn.zzz.com.ua/");
...
selCon2('about',2);
$about=$row['value'];
selCon2('email','info@modernvolyn.zzz.com.ua');
selCon2('tel1');
selCon2('tel2');
selCon2('address');
selCon2('fblink');
...
function head ($style=0, $cont=0, $title = 'Головна',$others=0){
	...
	$keywords.=$tags;
	$title.='Громадська організація "Сучасна Волинь"';
...
function down(){
	...
	<footer>
		...
		<div class="l_down text-center">&copy; <?=date("Y")?> Громадська організація "Сучасна Волинь"</div>
	</footer>
	<script>
