...
<html>
	...
	<body>
		...
		if($type==2)
			echo '<a style="color:#fff" class="btn btn-success" href="'.LINK.'adm/maerial.php?a=editPost&id='.$pRow['id'].'">Редагувати пост</a><a style="color:#fff" class="btn btn-danger" href="'.LINK.'adm/maerial.php?tab=5&r=deleted&id='.$pRow['id'].'">Видалити пост</a><br>';
